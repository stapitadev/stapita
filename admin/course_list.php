...
{
$select  = mysqli_query($con,"delete from `course` where `id`='$_REQUEST[d_id]' ")or die(mysqli_error($con));
?>
...
{
$msg ='<center><span style="color:#ff0000;">Course Updated Successfully<span></center>';
}
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
		...
		<h2>Course List <span style="float: right;"><a href="create_course.php">Add Course</a></span></h2>
		...
		<table class="table table-bordered datatable" id="table-4">
			...
			<tbody>
				...
				$select  = mysqli_query($con,"select * from `course` where `id`!='' order by `id` ASC ")or die(mysqli_error($con));
				$i='1';
			...
			<!--<td>	<center><img style="height: 100px;width: 120px" src="../assets/img/banner/<?php echo $select1['image']; ?>"></center></td>-->
					...
					<td class="sorting_1">
						<a href="create_course.php?e_id=<?php echo $select1['id'];?>" class="btn btn-default btn-sm btn-icon icon-left">
							<i class="entypo-pencil"></i>
							Edit
						</a>
						<?php //if($select1[type]=='1'){ ?>
						<a href="javascript:confirmDelete('course_list.php?d_id=<?php echo $select1['id']; ?>')" class="btn btn-danger btn-sm btn-icon icon-left">
