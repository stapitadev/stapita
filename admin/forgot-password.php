...
<head>
	...
	<title><?php echo $shopname; ?> | Forgot Password</title>
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<a href="index.php" class="logo">
				...
				<h3 class="text-center" style="color: #fff;"> Forgot Password to <strong class="text-custom" style="font-size:20px !important; "><?php echo $shopname; ?></strong> </h3>
			</a>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<form method="post" role="form">
				...
				<div class="form-steps">
					...
					<div class="step current" id="step-1">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-info btn-block btn-login" name="forgot_password">
								Forgot Password
			...
			<div class="login-bottom-links">
				...
				<a href="#"><?php echo $shopname; ?></a>  - <a href="#">Privacy Policy</a>
