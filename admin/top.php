...
$admin_info  = mysqli_query($con, "select * from `admin` where `id`='$_SESSION[memid]'") or die(mysqli_error($con));



$admin_info1 = mysqli_fetch_array($admin_info);
			...
			<div class="col-md-6 col-sm-8 clearfix">
				...
				<!--	<li class="profile-info dropdown">add class "pull-right" if you want to place this from right 
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="../assets/img/fav-icon.png" alt="" class="img-circle" width="44" />



							<?php //echo $admin_info1[name]; ?>
