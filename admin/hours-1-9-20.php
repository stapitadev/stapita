...
$insert = mysqli_query($con,"insert into `listing_business_hours`(`l_id`,`day`,`open_time`,`close_time`,`status`,`date`)values('$l_id','$day[$i]','$open_time[$i]','$close_time[$i]','$status','$date')") or die(mysqli_error($con));
