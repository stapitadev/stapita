						...
						<div class="col-12 col-md-10 offset-md-1 col-xl-8 offset-xl-2">
							...
							<figure class="acbFig text-gray888 text-center mb-6 mb-md-10">
								<div class="imgHolder mb-3">
									<img src="images/img122.jpg" class="img-fluid" alt="image description">
								</div>
								<figcaption>&copy; 2018 Art of Boby Morley / Artists Rights Academy, Columbia</figcaption>
							</figure>
							<!-- figRelActionList -->
							<ul class="list-unstyled d-flex flex-wrap text-center justify-content-center figRelActionList mb-0">
								<li>
								...
								<table class="apDataTable apDataTableII text-gray777 w-100 mt-5 mb-9 mb-lg-14">
									<tbody>
										...
										<tr>
											...
											<td>68 x 57,6 cm (26 3/4 x 22 11/16 inch)</td>
										</tr>
										<tr>
